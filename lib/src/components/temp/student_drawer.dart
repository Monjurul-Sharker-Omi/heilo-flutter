          ...
          Container(
            ...
            child: ListTile(
              ...
              onTap: () {
                ...
                //Navigator.of(context).push(MaterialPageRoute(builder: (context) => StudentSideMenuMobile()));
              },
            ),
          ),
          Container(
            ...
            child: ListTile(
              ...
              onTap: () {
                ...
                //Navigator.of(context).push(MaterialPageRoute(builder: (context) => StudentQuizMobile()));
              },
            ),
          ),
          Container(
            ...
            child: ListTile(
              ...
              onTap: () {
                ...
                //Navigator.of(context).push(MaterialPageRoute(builder: (context) => DashBoardMobile()));
              },
            ),
          ),
          Container(
            ...
            child: ListTile(
              ...
              onTap: () {
                ...
                //Navigator.of(context).push(MaterialPageRoute(builder: (context) => StudentProfileMobile()));
              },
            ),
          ),
          Container(
            ...
            child: ListTile(
              ...
              onTap: () {
                ...
                //Navigator.of(context).push(MaterialPageRoute(builder: (context) => const EditProfileMobile()));
              },
            ),
          ),
          Container(
            ...
            child: ListTile(
              ...
              onTap: () {
                ...
                //Navigator.of(context).push(MaterialPageRoute(builder: (context) => const StudentInboxMobile()));
              },
            ),
          ),
        ],
