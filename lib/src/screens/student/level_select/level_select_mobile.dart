...
class LevelSelectMobile extends StatefulWidget {
  const LevelSelectMobile({Key? key}) : super(key: key);

  @override
  State<LevelSelectMobile> createState() => _StudentPhase1MobileState();
}

class _StudentPhase1MobileState extends State<LevelSelectMobile> {
  _buildCard({
